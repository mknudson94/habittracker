...
class NfcUtilsTest {
    ...
    fun `parseHabitTrackerNdef parses intent correctly`() {
        ...
        val record1 = NdefRecord.createExternal("com.mk.habittracker", "habit", habitId.toByteArray())
        val record2 = NdefRecord.createExternal("com.mk.habittracker", "unused", "something".toByteArray())
